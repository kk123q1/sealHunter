//------------------------------------------------------------------------------//
//
// MODULE   : AIRespawnPoint.h
//
// PURPOSE  : AIRespawnPoint - Definition
//
// CREATED  : 05/14/2002
//
...
#ifndef __AIRESPAWNPOINT_H__
#define __AIRESPAWNPOINT_H__
...
enum EAIRespawnPointState
{
    ACTION_SPAWNED, // just spawned
    ACTION_WARPING, // AIRespawnPoints fall from the sky, don't they?
    ACTION_NORMAL,  // idle
...
//-----------------------------------------------------------------------------
class AIRespawnPoint : public BaseClass
{
...
private:
    ...
    uint8       m_nAIRespawnPointType;
    float       m_fAIRespawnPointValue;
    int8        m_iHitPoints;
